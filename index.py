...
# --- 1. CONFIGURACIÓN DEL ÍCONO (ENLACE ESTABLE) ---
# Usamos el de Wikimedia que es 100% público y rápido.
URL_ESCUDO = "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Escudo_del_Club_Atl%C3%A9tico_Newell%27s_Old_Boys.svg/240px-Escudo_del_Club_Atl%C3%A9tico_Newell%27s_Old_Boys.svg.png"

st.set_page_config(
    page_title="Acceso NOB", 
    layout="centered",
    page_icon=URL_ESCUDO
)

# --- 2. INTENTO DE FORZAR ÍCONO EN MÓVIL (HTML PURO) ---
# Esto inyecta las etiquetas estándar para "Agregar a inicio"
st.markdown(f"""
    <head>
        <link rel="apple-touch-icon" sizes="180x180" href="{URL_ESCUDO}">
        <link rel="icon" type="image/png" sizes="192x192" href="{URL_ESCUDO}">
        <link rel="shortcut icon" href="{URL_ESCUDO}">
    </head>
    <style>
        /* Ocultar elementos decorativos de Streamlit si es posible */
